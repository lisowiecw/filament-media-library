...
class AttachmentReconciler
{
    ...
    private function refuseUnreachable(array $desired, array $attached): void
    {
        ...
        // new. It is asked of the arriving ids, the same set reach judged,
        // since an id already attached is left alone whether its asset is
        // still live or not. An id naming no live asset is unknown, whatever
        // tenant is current; anything else that failed reach failed on the
        // boundary.
