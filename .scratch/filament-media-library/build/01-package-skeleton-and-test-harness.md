...
- [x] Declared requirements: `php ^8.3`, `laravel/framework ^13.0`, `filament/filament ^4.0|^5.0`, `enshrined/svg-sanitize ^0.22`, `spatie/laravel-package-tools ^1.93`; no Flysystem or AWS SDK constraint
